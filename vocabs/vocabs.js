...
var dictionary = new Array(
	...
	"sign of warning", "forebode, foreshadow, portend",
	"sign of warning", "portent, portend, premonition",
	"threatening", "intimidate, ominous, sinister",
	"very angry", "enrage, fume, glower, incense",
	"very angry", "infuriate, irate, ire, livid, rabid",
	"very angry", "seethe, smolder, wrath",
	"detailed knowledge", "intellectual, cerebral, erudite, pundit",
	"skillful", "adept, adroit, agile, consummate, deft",
	"skillful", "dexterous, proficient, prowess",
	"skillful (antonym)", "inept, maladroit",
	"flexible", "lithe, limber, nimble, supple",
	"having twists/turns", "circuitous, convoluted, intertwine, involved",
	"having twists/turns", "meander, sinuous, tortuous",
	"inclination", "affinity, aptitude, bent, disposed",
	"inclination", "penchant, predilection, predisposition",
	"inclination", "proclivity, propensity",
	"ineffective", "futile, ineffectual",
	"ineffective (antonym)", "efficacy",
	"horrifying", "shocking, aghast, appalling, egregious",
	"horrifying", "ghastly, grisly, gross, grotesque",
	"horrifying", "gruesome, heinous, hideous",
	"horrifying", "monstrous, morbid, unsightly, vile",
	"attractive", "aesthetic, comely",
	"separate", "disjointed, polarize, segregate",
	"nexus", "connected",
	"very talented", "prodigy, precocious",
	"foolish talk", "babble, blather, drawl, drival",
	"foolish talk", "gibberish, jabber, nonsensical",
	"foolish talk", "prate, prattle"
