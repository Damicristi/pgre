...
var dictionary = new Array(
	...
	"augur, augury, forecast, forsee, forsight", "prediction",
	"foretell, presage, prescience, prognosis", "prediction",
	"forebode, foreshadow, portend", "sign of warning",
	"portent, portend, premonition", "sign of warning",
	"intimidate, ominous, sinister", "threatening",
	"enrage, fume, glower, incense", "very angry",
	"infuriate, irate, ire, livid, rabid", "very angry",
	"seethe, smolder, wrath", "very angry",
	"intellectual, cerebral, erudite, pundit", "detailed knowledge",
	"adept, adroit, agile, consummate, deft", "skillful",
	"dexterous, proficient, prowess", "skillful",
	"(antonym) inept, maladroit", "skillful",
	"lithe, limber, nimble, supple", "flexible",
	"circuitous, convoluted, intertwine, involved", "having twists/turns",
	"meander, sinuous, tortuous", "having twists/turns",
	"affinity, aptitude, bent, disposed", "inclination",
	"penchant, predilection, predisposition", "inclination",
	"proclivity, propensity", "inclination",
	"futile, ineffectual", "ineffective",
	"(antonym) ineffective", "efficacy",
	"shocking, aghast, appalling, egregious", "horrifying",
	"ghastly, grisly, gross, grotesque", "horrifying",
	"gruesome, heinous, hideous", "horrifying",
	"monstrous, morbid, unsightly, vile", "horrifying",
	"aesthetic, comely", "attractive",
	"disjointed, polarize, segregate", "separate",
	"nexus", "connected",
	"prodigy, precocious", "very talented",
	"babble, blather, drawl, drival", "foolish talk",
	"gibberish, jabber, nonsensical", "foolish talk",
	"prate, prattle", "foolish talk",
	"dodge, avert, circumvent", "avoid",
	"deflect, elude, evade, evasive", "avoid",
	"parry, quibble, shirk, shunt", "avoid",
	"skirt, swerve", "avoid",
	"(antonym) avoid", "head-on",
	"clumsy, fumble, gauche", "awkward",
	"awkward, gawky, ungainly", "clumsy" ,
	"bouyant, sanguine", "optimists",
	"dally, dawdle, dilatory, linger", "be slow /waste time",
	"dally dally, laggard, malinger", "be slow /waste time",
	"didactic, pedantic", "to do with teaching",
	"diffuse, disseminate", "spread",
	"promulgate, propagate", "spread",
	"abhor, animosity, antipathy, aversion", "hate",
	"despicable, detest, loathe, odious", "hate",
	"repel, repugnant, repulsion", "hate",
	"antediluvian, antiquated, dated", "old fashioned / outdated",
	"archaic, obsolete, outmoded, quaint", "old fashioned / outdated",
	"anachronism, chronicle, chronological", "related to time",
	"chary, circumspect, gingerly, heedful", "cautious, careful",
	"leery, prudent, wary", "cautious, careful",
	"(antonym) daredevil, folly, rash", "cautious, careful",
	"(antonym) foolhardy, reckless, risky", "cautious, careful",
	"complacent, gloat, smirk, smug", "self-satisfaction",
	"admonish, censure, chastise, chide", "minor scolding/warning",
	"rebuke, reprimand, reproach, reprove", "minor scolding/warning",
	"assail, berate, castigate, decry", "disapprove, scold",
	"denounce, denunciation, diatribe, epithet", "disapprove, scold",
	"excoriate, fulminate, invective, lambaste", "disapprove, scold",
	"rant, revile, rile", "disapprove, scold",
	"tirade, upbraid, vituperative", "disapprove, scold",
	"drub, pulverize, subjugate", "to defeat",
	"vanquish, rout, capitulate", "to defeat",
	"axioms, canons, dictum, doctrine", "rule, principle, law",
	"dogmas, mandate, tenets", "rule, principle, law",
	"dessident, heresy, hertical, heterodox", "rebellious, unconventional",
	"iconoclast, insurgent, maverick" , "rebellious, unconventional",
	"nonconformist, radical, renegade", "rebellious, unconventional",
	"revolutionary, subversive, insurrection", "rebellious, unconventional",
	"(antonym) conservative, conventional", "rebellious, unconventional",
	"(antonym) hidebound, orthodox, reactionary" , "rebellious, unconventional",
	"(antonym orthodox)", "heterodox, rebellious, unconventional",
	"captious, carping, grouse, querulous", "complain",
	"jeopardy, pitfall, precarious, snare", "danger",
	"malevolence, malice, rancor", "bitter feelings, ill-will",
	"vicious, virulent", "bitter feelings, ill-will",
	"beset, beleaguered, plagued", "troubled",
	"abase, belittle, condescend, contempt", "mock, disrespect",
	"denigrate, deride, disdain, disparage", "mock, disrespect",
	"jeer, lampoon, patronize", "mock, disrespect",
	"sarcastic, sardonic, satire", "mock, disrespect",
	"scoff, scorn, sneer, snicker", "mock, disrespect",
	"snide, spurn, taunt", "mock, disrespect",
	"acclaim, accolade, applaud", "praise",
	"approbation, commendable, eulogy, exalt", "praise",
	"extol, glorify, hail, laud", "praise",
	"lionize, plaudit", "praise",
	"commensurate, parity, peers", "equality",
	"(antonym) disparate", "equality",
	"accord, concord, conformity,", "agreement, harmony",
	"congruous, consonance", "agreement, harmony",
	"(antonym) discord, discrepancy, faction", "agreement, harmony",
	"(antonym) incompatible, irreconcilable", "agreement, harmony",
	"chasm, dichotomy, gulf", "split, gap",
	"schism, rift", "split, gap",
	"bellicose, belligerent, contentious, disputatious", "aggressive, argumentative",
	"fractious, hostility, litigious", "aggressive, argumentative",
	"polemical, pugnacious, truculent", "aggressive, argumentative",
	"altercation, bicker, brawl, combat, contend,", "argue, fight",
	"row, scuffle, squabble, tiff, tussle", "argue, fight",
	"(antonym) fruce", "argue, fight",
	"astound, baffle", "confuse",
	"befuddle, bemuse, bewilder", "confuse",
	"confound, flabbergasted, foxed", "confuse",
	"nonplussed, obfuscate, perplex, stupefy", "confuse",
	"fawn, fulsome, obsequious, sycophant", "excessive flattery",
	"adulation, blandishment", "praise",
	"deprecatory, derogatory, pejorative", "insulting words",
	"aplomb, composure, equanimity, impassive", "clam",
	"imperturbable, nonchalant, phlegmatic", "calm",
	"placid, serene, staid, stolid, tranquil", "calm",
	"apathy, stoic", "indifferent",
	"alienate, antagonize, estrange", "make hostile",
	"comprehensive, encompass, expansive, pervasive", "include everything",
	"omnipresent, ubiquitous", "present everywhere",
	"insular, myopic, parachial, provincial", "narrow minded, regional",
	"bigot, discriminatory, partisan, prejudiced", "narrow minded, regional",
	"(antonym) disinterested", "narrow minded, regional",
	"dispassionate, egalitarian, equitable", "impartial", 
	"evenhanded, objectivity", "impartial",
	"blithe, facetious, frivolous", "not serious, disrespect",
	"frivolity, insouciant, levity", "not serious, disrespect",
	"(antonym) grave, gravity", "not serious, disrespect",
	"consternation, disconcert, dismay, disquiet", "disturbed, agitated",
	"distraught, faze, fluster, foment, frenetic", "disturbed, agitated",
	"hysterical, implacable, overwrought, perturb", "disturbed, agitated",
	"grovel, servile, subservient, slavish, supplicant", "overly obedient",
