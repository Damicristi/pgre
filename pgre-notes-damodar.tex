...
\item \textbf{Put suitable values:} If you can put values inside the expression or formula given in the choices then, you get a number. Now, your cleverness is to guess which number is reasonable for the given problem. 
\end{itemize}
