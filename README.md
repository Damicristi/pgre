...
<form method="POST" action="https://formspree.io/dphysicslog@gmail.com">
  ...
  <p><textarea name="message" cols="50" rows="5"> required style="padding: 8px;  border-radius: 4px;  border: 1px solid black; resize: vertical;" placeholder="Your message"></textarea></p>
